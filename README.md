...
## Source: 
Kaggle - https://www.kaggle.com/datasets/dhrubangtalukdar/telco-customer-churn-data
...
Open Python/telecome.ipynb in Jupyter Notebook.

Run the notebook cells sequentially to reproduce the analysis.

Optional: Open Power BI/Telecom Customer Churn Analysis & Revenue Impact Dashboard.pbix to explore interactive dashboards.
